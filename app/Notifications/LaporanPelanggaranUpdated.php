...
class LaporanPelanggaranUpdated extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ->subject('Laporan Pelanggaran Diperbarui')
            ->greeting('Halo!')
            ->line('Laporan pelanggaran telah diperbarui.')
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => 'Laporan pelanggaran telah diperbarui.',
        ];
    }
