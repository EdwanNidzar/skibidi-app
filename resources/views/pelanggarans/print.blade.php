    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center align-middle"><?php echo $data->suratKerja->nomor_surat_kerja; ?></td>
          <td class="text-center align-middle"><?php echo $data->parpol->parpol_name; ?></td>
          <td class="text-center align-middle"><?php echo $data->jenisPelanggaran->jenis_pelanggaran; ?></td>
