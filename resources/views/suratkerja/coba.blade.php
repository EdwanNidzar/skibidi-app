...
<body>
  <section class="sheet">
    ...
    <div class="content">
      <p>Berdasarkan Nomor Surat : <b>{{ $surat->nomor_surat_kerja }}</b> yang dilaporakan oleh <b>{{ $surat->assignTo->name }}</b>, memiliki beberapa pelanggaran yang terjadi di antaranya, sebagai berikut:</p>
