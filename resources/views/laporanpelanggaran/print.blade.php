...
<body>
  <section class="sheet">
    ...
    <table class="table">
      ...
      <tbody>
        <?php $no = 1; ?>
        <?php foreach ($laporanPelanggarans as $data) : ?>
        <tr>
          <td class="text-center align-middle"><?php echo $no; ?></td>
          <td class="text-center align-middle"><?php echo $data->pelanggaran->nama_bacaleg; ?></td>
          <td class="text-center align-middle"><?php echo $data->pelanggaran->jenisPelanggaran->jenis_pelanggaran; ?></td>
          <td class="text-center align-middle"><?php echo $data->pelanggaran->parpol->parpol_name; ?></td>
          <td>
