      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center align-middle">
            <img src="{{ public_path('storage/parpols/' . $data->parpol_picture) }}" alt="LOGO PARTAI" width="50px"
              height="50px">
          </td>
          <td class="text-center align-middle"><?php echo $data->parpol_number; ?></td>
          <td class="text-center align-middle"><?php echo $data->parpol_name; ?></td>
